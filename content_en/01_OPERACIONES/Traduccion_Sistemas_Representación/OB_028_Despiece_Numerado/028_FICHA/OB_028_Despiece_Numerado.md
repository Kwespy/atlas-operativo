...
A digital photograph is segmented into regions and translated into the visual language of a technical exploded view. Each region retains its photographic pixels, but begins to function as a separate and potentially identifiable part through outlines, assembly lines, marks, and numbering.
...
5. Distribute the parts in quantized directions and layers.
6. Optionally incorporate outlines, lines, origin points, and numbering.
7. Crop excess exterior space without removing parts.

**Controlled variables:**

- Approximate number of parts
- Compactness and smoothing of the segmentation
- Distance and variation of the explosion
- Number of directions and layers
- Presence of ghost image
- Guide lines, outlines, marks, and numbering
...
- Intersections and accumulations between parts and lines
- Degree of local recognition of each fragment
- Mental reconstruction performed by the viewer
...
The algorithm does not constitute the regime of the operation on its own. Segmentation and displacement are means to translate a raster photograph into the representation system of a numbered technical exploded view.
