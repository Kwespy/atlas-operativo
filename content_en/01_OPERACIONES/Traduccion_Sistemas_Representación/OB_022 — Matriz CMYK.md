...
The CMYK screen replaces photographic continuity with a structure of overlapping dots. As the halftone size increases, the shape fragments, contours lose precision, and color separates into chromatic interferences. The figure begins to merge with the background until its recognition becomes difficult. The visual support is also transformed: the image ceases to be perceived as a continuous photograph and appears as a graphic printing surface.
...
Works_on:: [[Estetico|Estetico]] [[Formal|Formal]] 
